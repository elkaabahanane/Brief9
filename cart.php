...
$(document).ready(function() {
    ...
    if (cartItems !== null) {
        ...
        products =
            "<tr class='text-center'><td>Currently you have no products in your cart</td></tr>"
    }

    document.getElementById("cart-products").innerHTML = products;
